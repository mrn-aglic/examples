...
class HttpSensorAsync(BaseSensorOperator):
    ...
    def __init__(
        ...
        endpoint: str = "",
        method: str = "GET",
        data: Optional[dict | list | MapXComArg | MappedArgument] = None,
    ...
    def execute(self, context: Context) -> Any:
        print("Execute BEFORE resolve")
        print(self.data)
        print(type(self.data))

        if isinstance(self.data, (MappedArgument, MapXComArg)):
            data = self.data.resolve(context)
        else:
            data = self.data

        print("Execute AFTER resolve")
        print(data)
        print(type(data))
